...
#define MIN_IFRAME_LENGTH 60
#define MAX_IFRAME_LENGTH 170                         // Calculated Max length is 154
const TickType_t xDelay = 25 / portTICK_PERIOD_MS;    // 25ms - Period of TaskReadSensors
